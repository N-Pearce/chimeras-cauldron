  ...
  return (
    <div className='itemCard' style={{paddingLeft: 10, paddingRight: 10}}>
        ...
        <p>&emsp;&emsp;The following Open Gaming License is for all spells and items that appear within this site
            ...
            created or shared between users afterwards are intellectual property of the creator, designated by the
            "Made by (creator)" tag.
        </p>
        <p>
        OPEN GAME LICENSE Version 1.0a  <br/><br/>
The following text is the property of Wizards of the 
Coast, Inc. and is Copyright 2000 Wizards of the 
Coast, Inc ("Wizards"). All Rights Reserved.  <br/><br/>
...
Game Content distributed using this License.  <br/><br/>
...
to Use, the Open Game Content.  <br/><br/>
...
rights to grant the rights conveyed by this License.  <br/><br/>
...
in and to that Product Identity.  <br/><br/>
...
permission from the Contributor to do so.  <br/><br/>
...
survive the termination of this License.  <br/><br/>
...
original material by E. Gary Gygax and Dave Arneson. <br/><br/> 
END OF LICENSE <br/><br/>
        </p>
    </div>
  )
}
