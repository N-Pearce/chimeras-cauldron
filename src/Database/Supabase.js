...
import ClassDB from '../Classes/ClassDB';
...
import MtgCardDB from '../MtgCards/MtgCardDB';
...
class Supabase {
    ...
    */
    ...
    static async getClassFeatures(name){
        return await ClassDB.findAll({name})
    }
    ...
    */
    ...
    static async getCharacterClassFeatures(character_id){
        return await CharacterDB.getClassFeatures(character_id)
    }
    
    static async addCharacterClassFeature(character_id, class_feature_id){
        return await CharacterDB.addClassFeature(character_id, class_feature_id)
    }
    ...
    */
    ...
    static async getMtgCards(name=''){
        return await MtgCardDB.findAll(name)
    }
}
